...
<div id="win" class="easyui-window" title="客户数据编辑" style="width:500px;height:300px"
    ...
    <form id="editForm" method="post">
        <%--提供id隐藏域，可在sevice层通过id是否为空判断是添加还是修改--%>
        <input type="hidden" name="id">
            <%--验证框，验证不能为空：class="easyui-validatebox" data-options="required:true"--%>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#editBtn").click(function () {
            ...
            //表单回显
            $("#editForm").form("load","/findById?id="+rows[0].id);
        ...
        $("#deleteBtn").click(function () {
            var rows = $("#list").datagrid("getSelections");
            if(rows.length==0){
                $.messager.alert("提示","删除操作至少选择选择一行","warning");
                return;
            }
